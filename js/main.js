    ...
    tt.find('.panel-heading').each(function () {
        $(this).find('a').click(function (e) {
            ...
            pan.toggleClass('show-content').find('.msg').text(function (i, txt) {
                return txt == jQuery.i18n.prop('topic.section.treatment-options.viewall') ? jQuery.i18n.prop('topic.section.treatment-options.hideall') : jQuery.i18n.prop('topic.section.treatment-options.viewall');
            });
...
window.addEventListener("load", function () {
    ...
    window.cookieconsent.initialise({
        ...
        "position": "bottom",
        "content": {
            "href": "https://www.bmj.com/company/your-privacy/",
...
$('.navbar-toggler.collapsed').click(function() {
    $('span.mobile-badge').toggle("slow", function(){});
});